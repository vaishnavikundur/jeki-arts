...
const TrackOrder = () => {
    ...
    const fetchOrderData = async (queryEmail, queryOrderId) => {
        ...
        setOrder(null);
        try {
            const res = await axios.post('http://localhost:5000/api/orders/track', { email: queryEmail, orderId: queryOrderId });
            setOrder(res.data);
        } catch (err) {
    ...
    const handleCancel = async () => {
        ...
        try {
            const res = await axios.put(`http://localhost:5000/api/orders/cancel-customer/${order._id}`, { email });
            setOrder(res.data);
    ...
    const confirmPayment = async () => {
        ...
        try {
            const res = await axios.put(`http://localhost:5000/api/orders/pay/${order._id}`, { transactionId });
            setOrder(res.data);
    ...
    const handleAgree = async () => {
        ...
        try {
            const res = await axios.put(`http://localhost:5000/api/orders/agree/${order._id}`, { email });
            setOrder(res.data);
